...
// Load .env / .env.local so the script works when run directly with `node scripts/migrate.js`
...
async function main() {
  if (!process.env.DATABASE_URL) {
    console.error('Error: DATABASE_URL is not set. Create a .env file or set the variable.')
    process.exit(1)
  }
